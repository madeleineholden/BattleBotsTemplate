...
'''
# FOR TESTING
base_url = 'http://52.207.242.165:3000/api/test/47' #os.getenv(‘BASE_URL’)
authentication_token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0ZWFtSWQiOiI1IiwidGVhbU5hbWUiOiJtYWRkeWRldGVjdG9yMSIsImlhdCI6MTczMjE1NjQzNSwiZXhwIjoxNzMyMjQyODM1fQ._OXuifMyYKqzOkkA6KJxWRErZl9yLdFGDJwhpTxK_dM'
session_id = 4 #os.getenv(‘SESSION_ID’)
'''
